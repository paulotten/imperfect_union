// copied from http://cliffle.com/p/dangerust/4/nbody-4.rs
// see http://cliffle.com/p/dangerust/4/
// and my comments marked with "paulotten:" around line 215
...
unsafe fn advance(bodies: &mut [body; BODIES_COUNT]){
    ...
    for i in 0..ROUNDED_INTERACTIONS_COUNT/2 {
        ...
        // paulotten: as_vectors() and as_scalars() are both presented as safe.
        // They both return mutable references to the same memory however.
        // This is unsafe!
        // 
        // Imagine I pass both of those references to different threads and start
        // writing to them at the same time. Undefined behavior.
        // Even writing from one thread and reading from the other could cause
        // undefined behaviour.
        // 
        // To quote https://doc.rust-lang.org/book/ch04-02-references-and-borrowing.html#mutable-references
        // "you can have only one mutable reference to a particular piece of data in a particular scope."
        let one_ref = magnitudes.as_vectors();
        let two_ref = magnitudes.as_scalars();
        // paulotten: It gets worse.
        // I can get as many of these mutable references as I like by using only
        // one of these functions...
        let red_ref = magnitudes.as_scalars();
        let blue_ref = magnitudes.as_scalars();
        // paulotten: Just to prove that the references are all still in scope and
